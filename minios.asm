...
cmd_loop:
    ...
    ; If the user just pressed enter (empty string), don't process
    CMP cmd_buffer, 0
    JE cmd_loop
    ...
    ; === CRITICAL FIX ===
    ; We must reset SI to point to the start of the command buffer 
    ; because add_to_history moved the SI pointer.
    LEA SI, cmd_buffer
    ...
    ; Check for 'help'
    LEA SI, cmd_buffer  ; Reset SI for every comparison
    LEA DI, help_cmd
    CALL compare_cmd
    CMP AL, 0
    JE cmd_do_help
